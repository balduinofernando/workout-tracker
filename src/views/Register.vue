<template>
	<div class="max-w-screen-sm mx-auto px-4 py-10">
		...
		<form class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
			<h1 class="text-3xl text-at-light-green mb-4">Registro</h1>
			...
			<div class="flex flex-col mb-2">
				<label for="password-confirmation" class="mb-1 text-sm text-at-light-green">Password
					Confirmation</label>
				<input type="password" v-model="confirmPassword" require class="p-2 text-gray-500 focus:outline-none"
					id="password-confirmation">
			</div>

			<button
				class="mt-6 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">Registar</button>
